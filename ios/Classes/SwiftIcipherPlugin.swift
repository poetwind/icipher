...
public class SwiftIcipherPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "icipher", binaryMessenger: registrar.messenger())
    let instance = SwiftIcipherPlugin()
